...
# ENV JAVA_OPTS="-XX:MaxPermSize=128m -Xmx1G -Dwflow.home=/joget/wflow/ -javaagent:/joget/wflow/aspectjweaver-1.8.5.jar"
ENV CATALINA_OPTS="-DjmxEnabled=true -Dcom.sun.management.jmxremote=true -Dcom.sun.management.jmxremote.rmi.port=9001 -Dcom.sun.management.jmxremote.port=9000 -Dcom.sun.management.jmxremote.ssl=false -Dcom.sun.management.jmxremote.authenticate=false -Dcom.sun.management.jmxremote.local.only=false -Djava.rmi.server.hostname=localhost"
